...
| ------------- |:-------------:|:-----:|-----|
| For 0.9.5.x Users      | 2017-02-21 | 0.9.5.2.4 | [w3-total-cache-fixed-(for-v0.9.5.x-users).zip](https://github.com/szepeviktor/w3-total-cache-fixed/releases/download/0.9.5.2.4/w3-total-cache-fixed-for-v0.9.5.x-users.zip) 
